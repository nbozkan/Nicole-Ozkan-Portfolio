...
public class CourseDaoDBTest 
{
    ...
    /**
     * Test of getCoursesForTeahcer method, of class CourseDaoDB.
     */
    @Test
    public void testGetCoursesForTeahcer() 
    {
        Teacher teacher = new Teacher();
        teacher.setFirstName("Test Teacher First");
        teacher.setLastName("Test Teacher Last");
        ...
        List<Course> courses = courseDao.getCoursesForTeahcer(teacher);
        assertEquals(2, courses.size());
        assertTrue(courses.contains(course));

...
public class TeacherDaoDB implements TeacherDAO
{
    ...
    {
        try {
           final String GET_TECHER_BY_ID = "SELECT * FROM teacher WHERE id = ?";
           return jdbc.queryForObject(GET_TECHER_BY_ID, new TeacherMapper(), id);
    ...
    public Teacher addTeacher(Teacher teacher) 
    {
        ...
        jdbc.update(INSERT_TEACHER, teacher.getFirstName(), teacher.getLastName(), teacher.getSpecialty());
    ...
    public void updateTeacher(Teacher teacher) 
    {
        ...
        jdbc.update(UPDATE_TEACHER, teacher.getFirstName(), teacher.getLastName(), teacher.getSpecialty(), teacher.getId());
    }
    ...
    {
        final String DELETE_COURSE_STUDENT = "DELETE cs.* FROM course_student cs JOIN course c ON cs.courseId = c.Id WHERE teacherId = ?";
